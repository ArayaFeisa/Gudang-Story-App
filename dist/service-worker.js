(() => {
        ...
        d = u
          ? await (async function (e, t, s, n) {
              ...
              const r = Object.assign(Object.assign({}, n), {
                ...
                i = await e.keys(t, r);
              for (const t of i) if (a === f(t.url, s)) return e.match(t, n);
            })(l, r.clone(), ["__WB_REVISION__"], h)
          : null;
      try {
        await l.put(r, u ? o.clone() : o);
      } catch (e) {
        if (e instanceof Error)
          throw (
  ...
  class y {
    ...
    handleAll(e) {
      ...
      const t = e.event,
        ...
        a = new m(this, { event: t, request: s, params: n }),
    ...
    async _handleFetch(e, t) {
        ...
        });
      {
        const n = a.integrity,
          ...
          i = !r || r === n;
        (s = await t.fetch(
          new Request(e, { integrity: "no-cors" !== e.mode ? r || n : void 0 }),
        )),
          n &&
            i &&
            "no-cors" !== e.mode &&
  ...
  function T(e, t, s) {
    ...
    if ("string" == typeof e) {
      ...
      a = new E(({ url: e }) => e.href === n.href, t, s);
    } else if (e instanceof RegExp) a = new L(e, t, s);
    else if ("function" == typeof e) a = new E(e, t, s);
    else {
      if (!(e instanceof E))
    ...
    return (
      (q || ((q = new U()), q.addFetchListener(), q.addCacheListener()),
      q).registerRoute(a),
      a
    );
  }
    ...
    return "function" == typeof e
      ? (t = e) !== IDBDatabase.prototype.transaction ||
        ...
        ? (
          ...
          ? function (...e) {
              return t.apply(F(this), e), j(M.get(this));
            }
          : function (...e) {
              return j(t.apply(F(this), e));
            }
        : function (e, ...s) {
            const n = t.call(F(this), e, ...s);
            return S.set(n, e.sort ? e.sort() : [e]), j(n);
          }
  ...
  (Q = W),
    (W = {
      ...Q,
      get: (e, t, s) => G(e, t) || Q.get(e, t, s),
      has: (e, t) => !!G(e, t) || Q.has(e, t),
    }),
    s(626);
  ...
  class z {
    ...
    async expireEntries(e, t) {
      ...
      const i = [];
      for (const e of a) await s.delete(Y, e.id), i.push(e.url);
      return i;
    }
    _getId(e) {
    ...
    async expireEntries() {
      ...
      (this._isRunning = !1),
        this._rerunRequested &&
          ((this._rerunRequested = !1), N(this.expireEntries()));
    }
  ...
  class Z {
    constructor(e = {}) {
      ...
      (this.cachedResponseWillBeUsed = async ({
        ...
        e.purgeOnQuotaError &&
          ((t = () => this.deleteCacheAndMetadata()), g.add(t));
    }
    _getCacheExpiration(e) {
      if (e === o()) throw new n("expire-custom-caches-only");
      let t = this._cacheExpirations.get(e);
      return (
        t || ((t = new X(e, this._config)), this._cacheExpirations.set(e, t)), t
      );
    }
  ...
  (ee = [
    ...
    { revision: "4b8485dbfd5941bccea72356294d77c2", url: "app.bundle.js" },
    {
      revision: "02b30a124d6d1bf13bfdc096f2b62c6e",
      url: "app.bundle.js.LICENSE.txt",
    },
    { revision: "0a567f07d90b558d1927fdcf58e13afd", url: "app.css" },
    { revision: "21a0a0a9b1fdb78eae4c9d97f7e90078", url: "favicon.png" },
    { revision: "529d922d85043160a6dc12acdb751250", url: "images/inilogo.png" },
    { revision: "ac73f380ba0147f4fa5951dfaba2a665", url: "images/logo.png" },
    { revision: "ec543d3bd784f14471c11eba8f5a8050", url: "images/pmpm.jpg" },
    {
    ...
    { revision: "6d76704657d5532271f07bf664210b76", url: "index.html" },
    { revision: "733765b87000653c24fc44cf59d1edde", url: "manifest.json" },
  ]),
    x().precache(ee),
    (function (e) {
      const t = x();
    ...
    T(
      ...
      new (class extends y {
        ...
        cacheName: "images",
        plugins: [new Z({ maxEntries: 50, maxAgeSeconds: 2592e3 })],
      }),
    ),
    T(
      /\.(?:css|js)$/i,
    ...
    self.addEventListener("push", function (e) {
      ...
      if (e.data)
        try {
          ...
          t = { title: "Push Notification", body: e.data.text() };
        }
      var s = t.title || "Push Notification",
        n = {
